...
const config: Config = {
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl:
            "https://github.com/opensupplyhub/supplychaindata.exchange/tree/main/website/docs/",
        },
        blog: {
          ...
          // Remove this to remove the "edit this page" links.
          editUrl:
            "https://github.com/opensupplyhub/supplychaindata.exchange/tree/main/website/blog/",
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} <a href="https://supplychaindata.exchange/">Supply Chain Data Exchange</a>.<br/>Built with <a href="https://docusaurus.io/">Docusaurus</a>.`,
    },
    prism: {
